...
class CenterDataSource {
    companion object Factory {
        fun loadRecycleInfoList():MutableList<CardInfo> {
            ...
            centerLayoutInfo.add(CardInfo(5,"软键盘与输入框的最佳实践","学习如何优雅弹出软键盘的同时输入框不被遮挡"))
            centerLayoutInfo.add(CardInfo(6,"Activity深度使用","学习activity用法"))
            centerLayoutInfo.add(CardInfo(7,"Fragment深度使用","学习fragment的用法"))
