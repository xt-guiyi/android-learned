...
class HomeDataSource {
    companion object Factory {
        fun loadRecycleInfoList():MutableList<HomeLayoutInfo> {
            ...
            homeLayoutInfos.add(HomeLayoutInfo(15,"Dialog控件","学习FragmentDialog的各种使用方式"))
            homeLayoutInfos.add(HomeLayoutInfo(16,"BottomSheet控件","学习BottomSheet控件的各种使用方式"))
            homeLayoutInfos.add(HomeLayoutInfo(17,"SeekBar控件","学习SeekBar控件的各种使用方式"))
            homeLayoutInfos.add(HomeLayoutInfo(18,"BadgeDrawable控件","学习BadgeDrawable控件的各种使用方式"))
            homeLayoutInfos.add(HomeLayoutInfo(19,"轮播图控件","学习Banner控件的各种使用方式"))
            homeLayoutInfos.add(HomeLayoutInfo(20,"tabs控件","学习TableLayout,TabItem控件的各种使用方式"))
            homeLayoutInfos.add(HomeLayoutInfo(21,"RecycleView控件","学习RecycleView控件的各种使用方式"))
            homeLayoutInfos.add(HomeLayoutInfo(22,"其他控件","学习一些杂类控件的各种使用方式"))
            homeLayoutInfos.add(HomeLayoutInfo(23,"协调者布局","学习协调者布局的使用，学习scrollFlags、behavior的用法等等"))
