...
import com.example.androidlearned.databinding.FragmentRecycleViewItem2Binding
...
class RecycleViewExample2Adapter(diffCallback: DiffUtil.ItemCallback<People>) : ListAdapter<People,RecycleViewExample2Adapter.ViewHolder>(diffCallback){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = FragmentRecycleViewItem2Binding.inflate(LayoutInflater.from(parent.context),parent, false)
    ...
    class ViewHolder(val binding: FragmentRecycleViewItem2Binding) : RecyclerView.ViewHolder(binding.root) {
