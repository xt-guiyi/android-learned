package com.example.androidlearned.customNavgination
...
public open class MainFragmentNavigator (context: Context, manager: FragmentManager, containerId: Int) :
    ...
    private val TAG = "MainFragmentNavigator"
